...
int main() {
	...
	Second_Sigma sec_sig{52, sm_kopt.get_min_path_length()};
	sec_sig.grind(mat, sm_kopt_freq_mat, start, num_iterations * 50);
	std::cout << "Ran " << num_iterations * 50 << " iterations of second sigma.\n";
	std::cout << "Found path of length " << sec_sig.get_min_path_length() << ".\n";
	std::cout << "--------------------------------------------------------------------------------\n";
	print_probability_matrix(sm_kopt_freq_mat);
